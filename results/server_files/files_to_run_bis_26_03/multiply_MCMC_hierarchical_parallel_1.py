...
mcmc = MCMC(mcmc_kernel, num_samples=sample_num, num_chains = chain_num, warmup_steps=1500)  # initialize MCMC class
mcmc.run(real_data)

# get results summary
summary_dict = mcmc.summary(prob=0.9)
torch.save(summary_dict, 'all_MCMC_summary_2.pth')

# get all the samples
samples_dict = mcmc.get_samples()
torch.save(samples_dict, 'all_MCMC_samples_2.pth')
