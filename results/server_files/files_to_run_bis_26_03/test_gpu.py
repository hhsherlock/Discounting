...
def model(data):
    ...
    group_beta_mean = pyro.sample("group_beta_mean", Normal(torch.tensor(1., device='cuda'), torch.tensor(2., device='cuda')))
...
torch.save(summary_dict, 'test_gpu.pth')

# get all the samples
samples_dict = mcmc.get_samples()
torch.save(samples_dict, 'test_gpu.pth')
