...
mcmc = MCMC(mcmc_kernel, num_samples=sample_num, num_chains = chain_num, warmup_steps=3200)  # initialize MCMC class
mcmc.run(real_data)

# get results summary
summary_dict = mcmc.summary(prob=0.9)
torch.save(summary_dict, 'beta_more_summary_1.pth')

# get all the samples
samples_dict = mcmc.get_samples()
torch.save(samples_dict, 'beta_more_samples_1.pth')
