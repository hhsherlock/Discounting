...
log_sigma_u_list = np.linspace(-4., 5., 1000)
log_a_list = np.linspace(-2., 1., 1000)
log_b_list = np.linspace(-4.5, 2., 1000)
log_beta_list = np.linspace(-1.5, 6.5, 1000)
...
def simulation(params):
    ...
    sigma_combine = sigma_u*(1+np.tanh(a*whole[:,0] + b))
...
def model(data):
    ...
    with pyro.plate('data', num_agents*num_trials):
        ...
        sigma_combine = sigma_u*(1+torch.tanh(a*data[:,:,0].view(-1) + b))
...
plt.savefig('/home/yaning/Documents/Discounting/paper/results/parameter_recovery_tanh.png')
...
with open('/home/yaning/Documents/Discounting/paper/results/parameter_recovery_tanh.pkl', 'wb') as f:
    pickle.dump(both_dict, f)

with open('/home/yaning/Documents/Discounting/paper/results/parameter_recovery_losses_tanh.pkl', 'wb') as f:
    pickle.dump(loss, f)